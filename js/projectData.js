...
export const projectData = [
    ...
    "subtitle": "Vortex enabled users to create 3D animated videos by composing a set of performances on characters, cameras or props in space and time. Built from 2020-21 at Teleportal.",
    "role": [
      "Technical Artist",
      "Software Engineer",
      "Product Designer",
  ...
  },
  {
    ...
    "description": "This was the first product Teleportal (the startup I co-founded/built from 2019-2024) built and released. The Teleportal SDK worked across platforms (iOS / Android / VR / PC / Mac) and interfaced with the Unity game engine and Three.js. The Teleportal SDK would seamlessly synchronize user locations and coordinate systems between devices and automatically save and retrieve persistent objects in the shared space. It was built around a modular and extensible service-oriented architecture in Typescript. My main responsibility was the SDK interface code and improving the developer experience in Unity with each release. Our partners built multiplayer games for Magic Leap, real-time multiuser art exhibits and virtual production software.<br><br><a href='https://medium.com/teleportal/announcing-teleportal-the-xr-telepresence-platform-350a710c4c0a' target=\"_blank\">Read more about Teleportal here</a> and view the archived <a href=\"https://web.archive.org/web/20200202004243/https://teleportal.dev/docs/\" target=\"_blank\">Developer Docs</a>.",
    "video": [
  ...
  },
  {
    ...
    "year": 2022,
    "details": "Unity 3D App (iOS + Android)",
    "subtitle": "Movieoke (Movie Karaoke) was a product for creating 3D animated remakes of iconic moments from movies and memes. We scaled our app to 320k users within our target demographic of teenage video creators.",
    "role": [
      "Software Engineer",
      "Technical Artist",
      "Product Manager",
    ...
    "description": "At Teleportal (the startup I co-founded/built from 2019-2023), democratizing 3D content creation was core to our vision. We pivoted from Vortex (project info on this site) to Movieoke at the end of 2021 to build a better UX around our learnings and better assist creators in overcoming the blank canvas problem.<br><br>Our team came up with Movie Karaoke as a fun way to reimagine storytelling with 3D Animated characters on a mobile device by putting facial capture and voice recording at the center of the UX. The UI was designed like Snapchat’s camera and having scene templates with a teleprompter made for creators to get started. Our product team of 6 artists/engineers built and released 20 Movieoke versions from April ’22 to March ’23 (at which point Movieoke became MovieBot). The 2.0 release was notable: it introduced UGC scenes and a custom character creator. These updates significantly improved the creation funnel (51% more recordings, 17% more exports).<br><br>My role during this time was multifaceted. Externally I was responsible for investor updates and internally, my main duty was as product manager working with our lead engineer and designer on scoping eng/tech art sprints to plan upcoming releases. As an individual contributor, I would focus on process improvements to the code managing our tech art process (Maya to Unity) and handle engineering tasks related to character animation system or Unity UI. I also managed release engineering and publishing app updates to Google Play/App Store after each sprint once a build passed QA. <br><br>In 7 months, we scaled from just an idea to 25k WAU/4k DAU on 322k total installs with an average rating of 4.6 starts on iOS/Android.<br><br><a href=\"https://medium.com/teleportal/now-playing-movieoke-2285d02cfa42\" target=\"_blank\">More information here</a>.",
    "video": [
  ...
  },
  {
    ...
    "description": "Built at Teleportal (the startup I co-founded/built from 2019-2023), MovieBot built upon Movieoke (see project info on this site) to make an even better UX for content creation in 3D. After an unfortunate 50% reduction in our team size, we were able to conceptualize, build and release MovieBot in just 8 weeks. The core difference between Movieoke and MovieBot is that in the former, creators must record each line of dialogue to make a video. But with MovieBot, creators can enter a topic and make a video instantly, then choose to tweak what gets created however they want. The emphasis on speed-to-create led to a 20% month over month growth rate for MovieBot compared to Movieoke from March to June 2023.<br><br>During this transitory period, I became CEO of our startup but remained focus on building the product as an PM, engineer and technical artist.<br><br>In addition to OpenAI gpt-3.5 for script writing, we integrated three other AI tools into MovieBot including Avaturn Avatars and Blockade Labs Skyboxes and ElevenLabs voices. We reached ~1 million installs worldwide and had over 120k MAU and began generating revenue with our MovieBot+ subscription. <br><br>Despite our team’s best efforts to build a great product and grow our revenue stream, we could not sustain development and the company shut down around January 2024. Fans of MovieBot continue to share old videos using the product today!",
    "video": [  
  ...
  },
  {
    ...
    "subtitle": "AnimAid is an AR tool for rapidly prototyping story ideas with voxel blocks that can be drawn over. Built at Creating Reality AR/VR Hackathon 2019 at MIT.",
    "role": [
      "Software Engineer",
      "Technical Artist"
    ],
